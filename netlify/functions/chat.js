...
exports.handler = async function(event, context) {
    ...
    // Your Personal AI Training Data
    ...
    try {
        ...
        if (!data.candidates || !data.candidates[0]) {
             return { statusCode: 500, body: JSON.stringify({ reply: "I'm having trouble thinking right now. Try again!" }) };
        }
        ...
        return {
            statusCode: 500,
            body: JSON.stringify({ error: "Failed to connect to the AI brain." })
        };
    }
}
